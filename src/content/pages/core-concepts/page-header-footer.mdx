...
| `editableHeader`                     | `boolean`                        | `true`               | 是否允许双击页眉打开行内编辑器                                               |
| `editableFooter`                     | `boolean`                        | `true`               | 是否允许双击页脚打开行内编辑器                                               |
...
| `headerAccentColor`                  | `string`                         | `accentColor` value  | 页眉编辑器覆盖层的强调色                                                    |
| `footerAccentColor`                  | `string`                         | `accentColor` value  | 页脚编辑器覆盖层的强调色                                                    |
