...
页眉和页脚不支持协作编辑。页眉和页脚的编辑器是独立的 Tiptap 实例，与主文档的协作会话无关。
...
| `openHeaderEditor`          | `{ pageNumber: number }`     | 打开指定页（从 1 开始）的页眉编辑器               |
| `openFooterEditor`          | `{ pageNumber: number }`     | 打开指定页（从 1 开始）的页脚编辑器               |
| `closeHeaderFooterEditors`  | 无                           | 关闭当前打开的页眉或页脚编辑器                     |
| `closeHeaderEditor`         | 无                           | 关闭页眉编辑器（如果已打开）                       |
| `closeFooterEditor`         | 无                           | 关闭页脚编辑器（如果已打开）                       |
