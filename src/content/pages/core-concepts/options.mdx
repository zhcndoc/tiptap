...
| `headerTopMargin`                    | `number`                         | 页面上边距的 50%    | 页顶到页眉内容的距离（px）             |
| `footerBottomMargin`                 | `number`                         | 页面下边距的 50%    | 页脚内容到底部的距离（px）          |
...
| `headerFooterExtensions`             | `Extensions`                     | `StarterKit`         | 内部页眉/页脚编辑器的扩展            |
