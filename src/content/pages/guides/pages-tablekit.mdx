...
- **Pages + DOCX import workflow.** You are importing `.docx` files and rendering them in a paginated editor. You need tables to paginate, **and** to faithfully reflect the original DOCX formatting (declared width, row height, indentation).
