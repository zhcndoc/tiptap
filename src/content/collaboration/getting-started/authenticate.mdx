...
Tiptap Collab 提供了撤销 JWT 的 API，以备需要，因此不建议将令牌设置得过短寿命。([查看撤销 JWT API](https://www.postman.com/tiptap-platform/workspace/tiptap-workspace/request/33042171-63ed5bbe-f54d-4a85-b2d0-5c1bc215d2fc))
