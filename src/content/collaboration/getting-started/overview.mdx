...
协作为您的编辑器添加实时协作编辑功能。在线状态指示器显示谁正在活跃，意识高亮显示每个用户的光标和选择，内置的 [版本历史](/collaboration/documents/snapshot) 和 [评论](/comments/getting-started/overview) 跟踪每个更改。
...
## 启用高级功能
- [版本历史](/collaboration/documents/snapshot) – 安装协作历史扩展，让用户恢复任何先前状态。
