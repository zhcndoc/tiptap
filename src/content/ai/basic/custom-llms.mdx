...
title: 集成自定义 LLM
meta:
  title: 自定义 LLM | Tiptap 基础 AI 生成
  description: 使用基础 AI 生成扩展实现自定义 LLM，并在编辑器中覆盖解析器函数。更多信息请参阅文档！
  category: 基础 AI 生成
---
...
如果你希望在某些情况下依赖我们的云服务，请确保你已[按照此处的说明设置你的团队](/ai/basic/install#start-your-content-ai-app)。
