...
AI Toolkit 方法允许你在特定位置[读取](/ai/ai-toolkit/client/api-reference/read-the-document)和[编辑](/ai/ai-toolkit/client/api-reference/edit-the-document)文档。
...
建议表示对文档的拟议更改。当 AI 对文档进行更改时，你可以将其显示为建议，以便用户审阅并接受或拒绝。了解更多信息，请参阅 [审核 UI 指南](/ai/ai-toolkit/client/agents/review-changes)。
...
Tiptap 编辑可作为 AI 代理使用的 [工具](/ai/ai-toolkit/client/agents/tools) 使用。它也可作为 [工作流](/ai/ai-toolkit/client/workflows/tiptap-edit) 使用。

要使 Tiptap 编辑正常工作，你需要先使用 Tiptap 读取来读取文档。Tiptap 读取可作为 AI 代理使用的 [工具](/ai/ai-toolkit/client/agents/tools) 使用，或作为 [工作流](/ai/ai-toolkit/client/workflows/tiptap-edit) 使用。
