...
title: 分屏视图
meta:
  title: 分屏视图 | Tiptap AI 工具包
  description: 构建并排差异视图，用于通过视觉对齐比较文档。
  category: AI 工具包
---
...
- [分屏视图 API 参考](/ai/ai-toolkit/client/api-reference/split-view)
- [比较文档](/ai/ai-toolkit/client/advanced-guides/compare-documents)：适用于内联单编辑器方法
