...
在 `streamHtml` 方法的 [审核更改指南](/ai/ai-toolkit/client/agents/review-changes) 和 [API 参考](/ai/ai-toolkit/client/api-reference/edit-the-document#streamhtml) 中了解更多关于审核选项的信息。
