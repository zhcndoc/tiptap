...
meta:
  title: Suggestions API 参考 | Tiptap AI 工具包
...
- [建议指南](/ai/ai-toolkit/client/agents/review-changes)
- [样式建议](/ai/ai-toolkit/client/agents/review-changes/style-suggestions)
...
了解如何通过 [样式建议指南](/ai/ai-toolkit/client/agents/review-changes/style-suggestions) 自定义建议的外观。
...
- `options` (`SetSuggestionsFromDiffOptions`): 文档比较的配置
  ...
  - `reviewOptions?` ([`ReviewOptions`](/ai/ai-toolkit/client/api-reference/review-options)): 控制如何对建议进行审核和显示的选项。[查看可用选项](/ai/ai-toolkit/client/api-reference/review-options)。
...
- `options` (`SetMarkdownSuggestionsOptions`): 配置项
  ...
  - `reviewOptions?` ([`ReviewOptions`](/ai/ai-toolkit/client/api-reference/review-options)): 控制预览/审核行为。[查看可用选项](/ai/ai-toolkit/client/api-reference/review-options)。
