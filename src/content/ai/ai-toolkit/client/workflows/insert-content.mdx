...
如果你的后端使用的不是 TypeScript，请参阅[本指南](/ai/ai-toolkit/client/advanced-guides/non-typescript-backends)。
...
- 使用 [**修订**](/tracked-changes/getting-started/overview) 扩展来渲染审阅界面。更改会作为文档的一部分保留，并对其他用户可见。
...
- [`createInsertContentWorkflow` 函数的 API 参考](/ai/ai-toolkit/client/api-reference/workflows#createinsertcontentworkflow)
- [`getHtmlRange` 方法的 API 参考](/ai/ai-toolkit/client/api-reference/read-the-document#gethtmlrange)
- [`streamHtml` 方法的 API 参考](/ai/ai-toolkit/client/api-reference/edit-the-document#streamhtml)
