...
- 使用 [**跟踪更改**](/tracked-changes/getting-started/overview) 扩展来渲染审阅界面。更改会作为文档的一部分保留，并对其他用户可见。
...
查看 [审阅更改](/ai/ai-toolkit/client/agents/review-changes) 指南，了解更多关于审阅界面的信息。

查看 [AI Toolkit 演示](https://github.com/ueberdosis/ai-toolkit-demos)，获取在审阅界面中使用 AI Toolkit 工作流的示例。
