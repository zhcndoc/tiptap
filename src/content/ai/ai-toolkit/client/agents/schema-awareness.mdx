...
将模式感知功能集成到类似于 [AI 代理聊天机器人指南](/ai/ai-toolkit/client/agents/ai-agent-chatbot) 中构建的 AI 代理中。
...
或者，你也可以配置 `getHtmlSchemaAwareness` 方法的 `customNodes` 选项。有关配置选项的更多信息，请参阅 [API 参考](/ai/ai-toolkit/client/api-reference/schema-awareness#gethtmlschemaawareness)。
...
下面的代码展示了一个使用 Next.js 和 Vercel AI SDK 构建的 API 端点，就像 [AI 代理聊天机器人指南](/ai/ai-toolkit/client/agents/ai-agent-chatbot) 中的示例一样。
...
下面的应用是带有已配置模式感知的 [AI 代理聊天机器人演示](/ai/ai-toolkit/client/agents/ai-agent-chatbot) 的一个变体。试着让 AI 创建一个警告框：AI 将识别该自定义元素并将其插入文档中。
