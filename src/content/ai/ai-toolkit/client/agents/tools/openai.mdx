...
meta:
  title: OpenAI - AI 代理工具 | Tiptap AI 工具包
  description: 使用 OpenAI 的工具定义，让 AI 代理能够读取并编辑 Tiptap 文档。
  category: AI 工具包
---

`@tiptap-pro/client-ai-toolkit-openai` 包提供了工具定义，你可以将其添加到使用 [OpenAI 的 JavaScript SDK](https://github.com/openai/openai-node) 构建的 AI 代理中。
...
```bash
npm install @tiptap-pro/client-ai-toolkit-openai
```
...
import { toolDefinitions } from '@tiptap-pro/client-ai-toolkit-openai'
...
包含已启用工具定义的数组，可与 [OpenAI 的 responses API](https://platform.openai.com/docs/api-reference/responses) 一起使用。要查看完整的工具列表，请参阅 [可用工具](/ai/ai-toolkit/client/agents/tools) 页面。
...
包含已启用工具定义的数组，可与 [OpenAI 的 completions API](https://platform.openai.com/docs/api-reference/completions) 一起使用。要查看完整的工具列表，请参阅 [可用工具](/ai/ai-toolkit/client/agents/tools) 页面。
