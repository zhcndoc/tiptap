...
meta:
  title: Mastra - AI 代理工具 | Tiptap AI 工具包
  description: 使用适用于 Mastra 的工具定义，让 AI 代理能够读取和编辑 Tiptap 文档。
  category: AI 工具包
---

`@tiptap-pro/client-ai-toolkit-ai-sdk` 软件包提供了工具定义，你可以将其添加到使用 [Mastra](https://mastra.ai/) AI 代理框架构建的 AI 代理中。
...
一个包含已启用工具定义的对象，可用于 [Mastra](https://mastra.ai/) 的工具调用系统。要查看完整的工具列表，请参阅 [可用工具](/ai/ai-toolkit/client/agents/tools) 页面。
