...
当使用 AI Agent 扩展并在后端运行自定义 AI 代理时，自定义系统提示词的方式取决于你所使用的 AI 模型提供商。更多信息请参阅我们的 [自定义 AI 代理集成指南](/ai/deprecated/agent/custom-llms/overview)。
...
制定合适的系统提示可能会很难。为了开始，可以复制此模板并根据您的需求进行调整。
