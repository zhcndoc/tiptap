...
- [通过 Tiptap Cloud 使用它](/ai/deprecated/agent/use-with-content-ai-cloud)，这提供了一个托管的、可直接使用的 AI 代理。
- [将其添加到您现有的 AI 代理中](/ai/deprecated/agent/custom-llms/overview)，该代理托管在您的后端中。

AI 代理扩展为流行的 AI 提供商库提供工具定义：

- [Vercel 的 AI SDK](/ai/ai-toolkit/client/agents/tools/ai-sdk)
