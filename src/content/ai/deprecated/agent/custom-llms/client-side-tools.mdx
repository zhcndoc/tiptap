...
`toolHandlersStarterKit` 包含所有 [内置工具](/ai/deprecated/agent/custom-llms/tools#built-in-tools) 的工具处理程序。你可以将自定义工具处理程序添加到数组中。
...
`toolsStarterKit` 包含所有[内置工具](/ai/deprecated/agent/custom-llms/tools#built-in-tools)的工具定义。你可以将自定义工具定义添加到数组中。
