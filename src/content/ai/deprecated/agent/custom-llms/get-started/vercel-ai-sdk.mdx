...
meta:
  title: 入门 Vercel AI SDK | Tiptap 内容 AI
...
<Callout title="Use with Vercel AI SDK v4" variant="info">
  要使用 Vercel AI SDK v4 而不是 v5，请导入 `vercelAiSdkV4Adapter`，而不是
  `vercelAiSdkAdapter`。
</Callout>
...
要编写系统提示，请参见 [系统提示指南](/ai/deprecated/agent/configure/system-prompt)。其中包含一个可作为起点使用的示例系统提示。
