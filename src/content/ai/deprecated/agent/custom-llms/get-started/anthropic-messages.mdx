...
To write the system prompt, see the [system prompt guide](/ai/deprecated/agent/configure/system-prompt). It includes an example system prompt that you can use as a starting point.
