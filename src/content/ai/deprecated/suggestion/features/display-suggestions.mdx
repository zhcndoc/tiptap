...
对于更高级的样式，请使用 `getCustomSuggestionDecoration` [配置选项](/ai/deprecated/suggestion/configure#custom-suggestion-styles)。
...
要了解如何在选择建议时显示弹出层，请[参考此指南](/ai/deprecated/suggestion/features/display-suggestions#show-a-popover-when-you-select-a-suggestion)。
...
我们建议使用 [Floating UI](https://floating-ui.com/) 库来显示弹出层。你可以在 [演示](/ai/deprecated/suggestion/overview) 中查看如何实现的示例。
...
你可以从扩展的 [storage object](/ai/deprecated/suggestion/api-reference#extension-storage) 中访问当前建议。
