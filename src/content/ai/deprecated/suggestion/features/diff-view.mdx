...
<Callout title="Note" variant="info">
  若要查看更改在应用到文档**之后**的效果，请参阅 [AI
  Changes](/ai/deprecated/changes/overview) 扩展。
</Callout>
...
了解如何在 [样式指南](/ai/deprecated/suggestion/features/display-suggestions) 中为建议添加高级样式。
...
审查基于差异的建议与审查常规建议的方式相同。有关更多信息，请参阅 [应用建议](/ai/deprecated/suggestion/features/apply-suggestions) 指南。
