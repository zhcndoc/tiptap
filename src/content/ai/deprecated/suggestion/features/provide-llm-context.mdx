...
当你使用 [通过 Tiptap Content AI cloud 生成建议](/ai/deprecated/suggestion/use-with-content-ai-cloud) 时，以下信息会发送给 LLM：

- 编辑器的内容。
- 扩展的 [规则](/ai/deprecated/suggestion/features/define-rules)。
- `context` 选项（如果提供）。
