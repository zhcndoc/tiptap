...
使用 AI Suggestion 扩展入门的最简单方式是使用 Tiptap Content AI Cloud。我们的 API 会根据你的规则和内容生成建议。请按照此设置指南操作：[使用 Tiptap Content AI Cloud](/ai/deprecated/suggestion/use-with-content-ai-cloud)。

你也可以使用自己的后端和 LLM 生成校对建议。你可以在这里找到指南：[集成你自己的后端和 LLM](/ai/deprecated/suggestion/custom-llms)。
...
您还可以通过提供自定义装饰来进一步自定义建议的外观。要在选择建议时显示工具提示或弹出层，请[参考本指南](/ai/deprecated/suggestion/features/display-suggestions#show-a-popover-when-you-select-a-suggestion)。
