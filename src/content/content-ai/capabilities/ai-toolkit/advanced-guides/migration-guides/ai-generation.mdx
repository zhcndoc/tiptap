...
在[审核更改指南](/content-ai/capabilities/ai-toolkit/agents/review-changes)以及 `streamHtml` 方法的[API 参考](/content-ai/capabilities/ai-toolkit/api-reference/edit-the-document#streamhtml)中了解更多关于审核选项的信息。
...
- 在 [AI 代理聊天机器人指南](/content-ai/capabilities/ai-toolkit/agents/ai-agent-chatbot) 中构建一个能编辑 Tiptap 文档的 AI 助手。
