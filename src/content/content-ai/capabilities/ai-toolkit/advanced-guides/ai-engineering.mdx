...
- Claude Sonnet 4.5（Anthropic）：这是我们获得最佳效果的模型，擅长对文档进行精确且高效的小幅编辑。
...
并非所有文档编辑的 AI 用例都是智能体类型，有时你只是需要 AI 生成内容并插入文档。大量经济型模型适合此用途。比如：
...
不过，在系统提示里你可以按名称引用[可用工具](/content-ai/capabilities/ai-toolkit/tools/available-tools)，这样你可以指导 AI 模型如何以及何时使用工具，并引导它变得更健谈、有创造力或更细致。
