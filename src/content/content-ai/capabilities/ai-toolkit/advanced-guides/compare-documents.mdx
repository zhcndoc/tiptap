...
差异会以 [建议](/content-ai/capabilities/ai-toolkit/api-reference/suggestions) 的形式显示在编辑器中。将以下 CSS 文件添加到您的应用中，以将建议格式化为红绿对比差异：
...
调用 `getSuggestions` 可获取文档之间的变更列表，这些变更会以 [建议](/content-ai/capabilities/ai-toolkit/api-reference/suggestions) 的形式存储。
