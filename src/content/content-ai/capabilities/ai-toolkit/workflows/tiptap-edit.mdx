...
查看 [review changes](/content-ai/capabilities/ai-toolkit/agents/review-changes) 指南，了解更多关于审阅界面的信息。
...
- [AI Caret](/content-ai/capabilities/ai-toolkit/advanced-guides/ai-caret)：在 AI 插入内容的位置显示光标。
