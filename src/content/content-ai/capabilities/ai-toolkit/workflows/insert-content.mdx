...
如果您想在不进行流式传输的情况下将内容插入文档，请使用 `insertHtml` 方法。该方法与 `streamHtml` 具有相同的选项，只是它会以完整的 HTML 内容作为参数一次性调用。请参阅 [API 参考](/content-ai/capabilities/ai-toolkit/api-reference/edit-the-document#inserthtml)。
...
请参阅 [审阅更改](/content-ai/capabilities/ai-toolkit/agents/review-changes) 指南了解有关审阅界面的更多信息。
...
- [AI 光标](/content-ai/capabilities/ai-toolkit/advanced-guides/ai-caret)：显示 AI 正在插入内容的位置的光标。
