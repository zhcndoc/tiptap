...
要使用 AI 工具包实现相同功能，推荐的路径是遵循[内联编辑指南](/content-ai/capabilities/ai-toolkit/guides/inline-edits)。
...
- 查看如何在[内联编辑指南](/content-ai/capabilities/ai-toolkit/guides/inline-edits)中使用 AI 工具包实现内联编辑的演示。  
