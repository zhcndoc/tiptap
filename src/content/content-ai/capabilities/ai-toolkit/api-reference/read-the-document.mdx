...
- `reviewOptions?` ([`ReviewOptions`](/content-ai/capabilities/ai-toolkit/api-reference/review-options)): 用于决定应读取哪种文档表示形式的审阅模式选项。
...
- `options?` (`TiptapReadChunksOptions`): `tiptapReadChunks` 方法的选项
  ...
  - `reviewOptions?` ([`ReviewOptions`](/content-ai/capabilities/ai-toolkit/api-reference/review-options)): 用于决定应对哪种文档表示形式进行分块的审阅模式选项。
