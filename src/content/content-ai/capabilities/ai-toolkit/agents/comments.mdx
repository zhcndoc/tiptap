...
想要进行文档编辑并将其与评论关联起来吗？请参阅[带评论的跟踪更改指南](/content-ai/capabilities/ai-toolkit/agents/review-changes/tracked-changes-with-comments)，了解如何将 AI 生成的跟踪更改与解释每项更改的评论线程结合使用。
