...
要实现此功能，我们将使用 AI 工具包的[实时比较文档](/content-ai/capabilities/ai-toolkit/api-reference/compare-documents)能力。
...
了解更多关于 AI 工具包的[实时比较文档](/content-ai/capabilities/ai-toolkit/api-reference/compare-documents)功能。
