...
<Callout title="延续 AI 代理聊天机器人指南" variant="info">
...
要在我们之前构建的[AI 代理聊天机器人](/content-ai/capabilities/ai-toolkit/agents/ai-agent-chatbot)中添加流式传输，我们需要用 `streamTool` 方法替换 `executeTool` 方法。
...
要在我们之前构建的[AI 代理聊天机器人](/content-ai/capabilities/ai-toolkit/agents/ai-agent-chatbot)中实现此流程，请按照以下步骤：
...
有关配置选项和 CSS 样式，请参阅 [AI Caret 指南](/content-ai/capabilities/ai-toolkit/advanced-guides/ai-caret)。
...
要了解更多关于审阅界面的信息，请参阅[审阅更改](/content-ai/capabilities/ai-toolkit/agents/review-changes)指南。

有关如何将 AI Toolkit 流式传输与审阅界面结合使用的示例，请参阅 [AI Toolkit 演示](https://github.com/ueberdosis/ai-toolkit-demos)。

## 下一步

- [审阅更改指南](/content-ai/capabilities/ai-toolkit/agents/review-changes)：让用户在更改应用之前预览并批准更改。
- [AI Caret](/content-ai/capabilities/ai-toolkit/advanced-guides/ai-caret)：在 AI 正在插入内容的位置显示光标。
