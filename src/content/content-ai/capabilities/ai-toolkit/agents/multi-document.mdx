...
- 让您的用户通过[审阅更改指南](/content-ai/capabilities/ai-toolkit/agents/review-changes)审阅 AI 生成的更改
- 添加实时工具流以实时查看更改，详见[流指导](/content-ai/capabilities/ai-toolkit/agents/streaming)
