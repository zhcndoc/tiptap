...
包含已启用工具定义的数组，可用于 [OpenAI 的 responses API](https://platform.openai.com/docs/api-reference/responses)。完整工具列表请参见 [可用工具](/content-ai/capabilities/ai-toolkit/tools/available-tools) 页面。
...
包含已启用工具定义的数组，可用于 [OpenAI 的 completions API](https://platform.openai.com/docs/api-reference/completions)。完整工具列表请参见 [可用工具](/content-ai/capabilities/ai-toolkit/tools/available-tools) 页面。
