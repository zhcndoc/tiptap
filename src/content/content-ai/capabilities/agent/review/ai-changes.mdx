...
<Callout title="注意" variant="info">
  我们在 [介绍页面](/content-ai/capabilities/agent) 提供了如何集成 AI 更改扩展的代码示例。
</Callout>
...
<Callout title="注意" variant="info">
  AI 更改扩展允许用户在更改应用后进行审核。若要在更改应用前进行审核，请集成 [AI 建议](/content-ai/capabilities/agent/review/ai-suggestion) 扩展。
</Callout>