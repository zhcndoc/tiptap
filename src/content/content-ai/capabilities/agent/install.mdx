...
<Requirements>
  ...
  <RequirementItem label="2. 集成 AI 提供商">
    ...
    [自定义大语言模型指南](/content-ai/capabilities/agent/custom-llms)。
  </RequirementItem>
...
AI Agent 可开箱即用地 [使用 Tiptap Cloud](/content-ai/capabilities/agent/use-with-content-ai-cloud) 作为后端。如果您想使用自己的后端，请阅读我们的 [自定义大语言模型和后端集成指南](/content-ai/capabilities/agent/custom-llms)。
