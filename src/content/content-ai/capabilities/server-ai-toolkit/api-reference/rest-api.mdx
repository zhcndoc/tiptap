...
有关如何创建密钥对并签名令牌，请参阅 [认证](/authentication)；完整设置请参阅 [授权指南](/content-ai/capabilities/server-ai-toolkit/install#set-up-authorization)。
...
- `document` (`object`, required): 要对其执行工具的文档。使用
  ...
  `{ "type": "inline", "content": { /* Tiptap JSON 文档 */ } }`，当你想在请求体中提供
  Tiptap JSON 文档时。
