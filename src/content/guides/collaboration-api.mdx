...
请注意，你需要将 `APP_ID`、`DOCUMENT_NAME` 和 `API_SECRET` 替换为你自己的值。`APP_ID` 是你的文档服务器 ID，在 [Cloud 控制台](https://cloud.tiptap.dev/v2/configuration/document-server) 中标记为 "Document server ID"。
