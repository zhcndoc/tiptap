...
从 [Slate](https://docs.slatejs.org/) 迁移到 Tiptap 十分简单。本指南将帮助你从 Slate 的 JSON 结构过渡到 Tiptap 的扩展系统。
...
1. 安装 Tiptap 包
2. 将 Slate JSON 内容转为 HTML 或 Tiptap JSON
3. 替换 Slate 编辑器初始化为 Tiptap 设置
4. 将 Slate 插件映射为 Tiptap 扩展
5. 迁移自定义元素至 [节点视图](/editor/extensions/custom-extensions/node-views)
6. 将工具栏组件迁移至 Tiptap UI
7. 测试内容兼容性
