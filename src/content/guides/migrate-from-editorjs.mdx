...
从 [Editor.js](https://editorjs.io/) 迁移到 Tiptap 非常简单。本文档将帮助你从 Editor.js 的块级结构过渡到 Tiptap 的文档模型。
...
1. 安装 Tiptap 包
2. 将 Editor.js JSON 内容转换为 HTML
3. 用 Tiptap 设置替换 Editor.js 初始化
4. 将 Editor.js 工具映射到 Tiptap 扩展
5. 将自定义工具迁移为自定义扩展或 [节点视图](/editor/extensions/custom-extensions/node-views)
6. 实现工具栏 UI 组件
7. 测试内容兼容性
