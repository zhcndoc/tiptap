...
<Requirements>
    ...
    <RequirementItem label="2. Install from private repository">
        To install this frontend extension, authenticate according to the [setup guide](/guides/pro-extensions) to access Tiptap's private npm repository.
    </RequirementItem>
</Requirements>
