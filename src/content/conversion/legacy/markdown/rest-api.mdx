...
<Callout title="旧版 Markdown REST API — 废弃警告" variant="warning">
    此 REST API 已被废弃，并将于 2026 年某个时间点停止服务，届时团队会提前通知。新的集成请使用最新的[Markdown 导出 REST API](/conversion/export/markdown/rest-api)和[Markdown 导入 REST API](/conversion/import/markdown/rest-api)。
</Callout>
