...
<Callout title="旧版 Markdown 编辑器扩展（已弃用）" variant="warning">
    这些编辑器扩展已被弃用，并将在 2026 年的某个时间点停止支持，团队会提前通知。对于新的集成，请使用更新后的 [Markdown 导出扩展](/conversion/export/markdown/editor-extension) 和 [导入 REST API](/conversion/import/markdown/rest-api)。
</Callout>
