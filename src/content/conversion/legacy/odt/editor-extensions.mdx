...
<Callout title="旧版 ODT 编辑器扩展（已弃用）" variant="warning">
    这些编辑器扩展已被弃用，并将在 2026 年的某个时间点停止支持，届时团队会提前通知。对于新的集成，请使用更新后的 [ODT 导出扩展](/conversion/export/odt/editor-extension) 和 [导入扩展](/conversion/import/docx/editor-extension)。
</Callout>
