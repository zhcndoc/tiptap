...
<Callout title="旧版 ODT REST API（已弃用）" variant="warning">
    该 REST API 已弃用，并将在 2026 年的某个时间点停止服务，届时团队会提前通知。对于新的集成，请使用更新后的 [ODT 导出 REST API](/conversion/export/odt/rest-api) 和 [导入 REST API](/conversion/import/docx/rest-api)。
</Callout>
