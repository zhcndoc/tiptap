...
<Callout title="Legacy ODT REST API — Deprecated" variant="warning">
    该 REST API 已被弃用，预计将在 2026 年的某个时间点终止，团队会提前通知。对于新的集成，请使用更新的[ODT 导出 REST API](/conversion/export/odt/rest-api)和[导入 REST API](/conversion/import/docx/rest-api)。
</Callout>
