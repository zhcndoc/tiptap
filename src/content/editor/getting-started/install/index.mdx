...
title: 安装编辑器
meta:
  title: 安装编辑器 | Tiptap 编辑器文档
  description: 将 Tiptap 编辑器集成到您的项目中。Tiptap 是独立于框架的，与大多数框架完全兼容。
  category: 编辑器
---

Tiptap 是独立于框架的，甚至可以与纯 JavaScript 一起使用（如果这是您喜欢的）。使用以下指南将 Tiptap 集成到您的 JavaScript 项目中。
