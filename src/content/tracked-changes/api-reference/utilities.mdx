...
| 选项 | 类型 | 说明 |
| --- | --- | --- |
| `type` | `SuggestionType` | 按[建议类型](/tracked-changes/api-reference/types#suggestiontype)过滤 |
...
有关将 NodeView 与 Tracked Changes 集成的详细指南，请参阅 [NodeView 支持指南](/tracked-changes/guides/nodeview-support)。
